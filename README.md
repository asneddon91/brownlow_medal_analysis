...
Analysing whether strong performance in individual statistical categories positively correlates with success in the Brownlow Medal. With this being my first attempt at producing a case study, I'm looking to outline the process I followed as well as the findings I uncovered.
...
An example of the disposals positive correlation is below:
